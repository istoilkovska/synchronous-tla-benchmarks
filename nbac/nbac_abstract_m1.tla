...
U == 1 .. 7 \* array indices (process locations + 2 concrete processes)
...
Justification == ([](loc1.halt => loc1.W = {1})) => (\A l \in Active : l.W = {1})
...
\* Last modified Tue Oct 17 13:42:32 CEST 2017 by stoilkov
\* Created Thu Sep 28 17:41:07 CEST 2017 by stoilkov
